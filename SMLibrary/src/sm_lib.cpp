...
BOOL InjectFMOD() {
	...
	try {
		...
		Console::log(Color::White, "SM: p1 -> [%p]", (void*)p1);
	} catch(...) {
		Console::log(Color::Red, "Failed to execute pointer code");
	}

	Console::log(Color::White, "Read FMOD system pointers: [%p]", system_1);
